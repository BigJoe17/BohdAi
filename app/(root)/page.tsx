        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Natural conversation with AI</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">DSA Chat Support</h3>
                <p className="text-gray-600 text-sm">Code & algorithm questions</p>
              </div>
            </div>
            <p className="text-gray-700 mb-4">
